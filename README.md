...
Converts currency exchange using [fixer.io](https://fixer.io) JSON API

APILayer allows for 100 requests per month for 168 world currencies.

Register for your free API key and update `apikey.txt` with your key.
...
Options:
-l, --list                      Display currency symbols list and quit.
-h, --help                      Display this help menu and quit.
```

### Converting currencies
Example conversion of 1 USD to JPY:
...
### Displaying currency symbols list
`./exchange --list`
...
BYN: New Belarusian Ruble                   BYR: Belarusian Ruble
...
CRC: Costa Rican Colón                      CUC: Cuban Convertible Peso
CUP: Cuban Peso                             CVE: Cape Verdean Escudo
CZK: Czech Republic Koruna                  DJF: Djiboutian Franc
...
JEP: Jersey Pound                           JMD: Jamaican Dollar
...
LBP: Lebanese Pound                         LKR: Sri Lankan Rupee
LRD: Liberian Dollar                        LSL: Lesotho Loti
LTL: Lithuanian Litas                       LVL: Latvian Lats
LYD: Libyan Dinar                           MAD: Moroccan Dirham
MDL: Moldovan Leu                           MGA: Malagasy Ariary
MKD: Macedonian Denar                       MMK: Myanma Kyat
...
PYG: Paraguayan Guarani                     QAR: Qatari Rial
...
TOP: Tongan Paʻanga                         TRY: Turkish Lira
...
VEF: Venezuelan Bolívar Fuerte              VND: Vietnamese Dong
VUV: Vanuatu Vatu                           WST: Samoan Tala
XAF: CFA Franc BEAC                         XAG: Silver (troy ounce)
